...
namespace AcessoDados.DML
{
    public abstract class DMLBase
    {
        ...
        public virtual ResultadoTransacao Select(ObjVOBase pObjVO) { return null; }
        public virtual ResultadoTransacao Insert(ObjVOBase pObjVO) { return null; }
        public virtual ResultadoTransacao Update(ObjVOBase pObjVO) { return null; }
        public virtual ResultadoTransacao Delete(ObjVOBase pObjVO) { return null; }
        ...
        protected ResultadoTransacao Executar(InformacaoTransacao pInformacaoTransacao)
        {
            ...
            //            
            return bancoDados.Execute(pInformacaoTransacao);
        }
        ...
        protected ResultadoTransacao ExecutarTransacao(List<InformacaoTransacao> pInformacaoTransacaoList)
        {
            BancoDados bancoDados = new BancoDados();
            //            
            return bancoDados.ExecuteTransaction(pInformacaoTransacaoList);
        }
